...
var ARContent = require('../models/arContent');
...
exports.saveContent = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var _req$body, userId, text, scale, position, rotation, files, folderName, folderPath, modelPath, _iterator, _step, file, filePath, newContent, result, modelUrl, qrCodeImageUrl;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _req$body = req.body, userId = _req$body.userId, text = _req$body.text, scale = _req$body.scale, position = _req$body.position, rotation = _req$body.rotation;
          files = req.files; // Nhiều file đã được tải lên
        ...
        case 5:
          ...
          folderName = "".concat(userId, "_").concat(Date.now());
          folderPath = path.join(__dirname, '../../public/models', folderName);
          modelPath = "/models/".concat(folderName, "/").concat(path.basename(files[1].originalname));
          _context.next = 10;
        ...
        case 28:
          ...
          newContent = new ARContent({
            ...
            rotation: rotation ? JSON.parse(rotation) : {
              x: 0,
              y: 0,
              z: 0
            }
        ...
        case 31:
          ...
          // Tạo mã QR cho URL của mô hình
          modelUrl = "".concat(URL_CLIENT).concat(modelPath);
          _context.next = 35;
          return QRCode.toDataURL(modelUrl);
        case 35:
          qrCodeImageUrl = _context.sent;
          res.status(201).json({
            message: 'AR content saved successfully',
        ...
        case 39:
          ...
          res.status(500).json({
            message: 'Error saving AR content',
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 9:
          ...
          res.status(500).json({
            message: 'Error retrieving AR content',
